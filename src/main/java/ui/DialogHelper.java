...
public final class DialogHelper {
	...
	public static void showEntryDialog(UserInterface parentUi, String title, TimesheetEntry entry) {
		...
		makeEntryButton.addActionListener(e -> {
			makeEntryAction(parentUi, durationWarningLabel, actionTextField, timeFields, vacationCheckBox);
			dialog.dispose();
		});
	...
	private static void makeEntryAction(UserInterface parentUI, JLabel durationWarningLabel, JTextField actionTextField, JTextField[] timeFields,
